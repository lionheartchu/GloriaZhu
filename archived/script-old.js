...
const hoverTargets = document.querySelectorAll(
  '.nav-links li a, .gloria, .zhu, .section-title, .project-title, .title-item, .fb-title, .project-category, .project-time, .sec-title, .back-link, .next-project-card, .btn-cta, .resume-button, .project-link, .logo, .elegant-email, a, button'
  );
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Halo effect disabled - return early
    return;
